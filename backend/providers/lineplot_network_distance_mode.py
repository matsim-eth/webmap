...
class LineplotNetworkDistanceModeProvider(DataProvider):
    """Network-distance lineplot grouped by transport mode.
    ...
    ROUTE = "lineplot_network_distance_data_mode.json"
